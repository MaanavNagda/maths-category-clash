/* Display role renderer (online). Subscribes to the public snapshot in
   Firebase — never receives answers before reveal time. Tile clicks and
   reveal clicks are forwarded to the host tab via the requests queue. */
...
initOnline("display", render, paintTimer);
